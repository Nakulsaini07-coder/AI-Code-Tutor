...
//     setError("⚠️ Your code is too long! Please limit it to 10,000 characters.");
//     return;
//   }
...
//       {/* <p className="text-sm mt-2 text-gray-400">Generating...</p> */}
//     </div>
//   );
...
//             <span className="text-xl font-semibold text-gray-900 dark:text-gray-100">AI Code Tutor</span>
//           </div>
...
//             Paste your code and get instant, intelligent explanations to help you learn and understand programming concepts.
//           </p>
//         </div>

//         {/* Code input section */}
//         <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 sm:p-8 mb-6">
//           <label htmlFor="code-input" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">
//             Code Input
//           </label>
//           <textarea
//             ref={textareaRef}
...
//             className="code-textarea w-full min-h-[200px] max-h-[400px] p-4 border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none transition-colors duration-200"
//             rows="8"
//           />
...
//               Tip: Press Ctrl+Enter (Cmd+Enter on Mac) to explain code quickly
//             </p>
...
//             className="inline-flex items-center px-8 py-3 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed text-white font-medium rounded-lg shadow-lg hover:shadow-xl transform hover:scale-105 disabled:transform-none transition-all duration-200 text-lg"
//           >
//             {isLoading ? (
//               <>
...
//                     <svg className="h-8 w-8 text-blue-600 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
//                       <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
//                     </svg>
//                   </div>
...
//                 <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 whitespace-pre-wrap text-sm leading-relaxed text-gray-800 dark:text-gray-200">
//                   {explanation}
//                 </div>
//               </div>
//             )}
...
//               Paste your code above and click "Explain Code" to get started
//             </p>
//           </div>
//         )}
//       </main>
